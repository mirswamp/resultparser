...
sub summary {
    ...
    my $mcm =
	    $twig->first_elt('McCabes_cyclomatic_complexity_per_module')
	    ->att('value');
    my $loc  = $twig->first_elt('lines_of_comment')->att('value');
    my $locm = $twig->first_elt('lines_of_comment_per_module')->att('value');
    my $loclc =
	    $twig->first_elt('lines_of_code_per_line_of_comment')->att('value');
    my $mcclc =
	$twig->first_elt('McCabes_cyclomatic_complexity_per_line_of_comment')
	->att('value');
...
sub modules {
    ...
    my $locplc =
	    $mod->first_child('lines_of_code_per_line_of_comment')->att('value');
    my $mcclm =
	    $mod->first_child('McCabes_cyclomatic_complexity_per_line_of_comment')
	    ->att('value');
    $h{$counter}{'name'}                                              = $name;
